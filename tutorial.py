...
class Spikes(Object):
    def __init__(self, x, y, width, height):
        ...
        self.image = self.load_sprite("Traps", "Spikes", "idle.png", width, height)
        self.rect = self.image.get_rect(topleft=(x, y))
        self.mask = pygame.mask.from_surface(self.image)

    def load_sprite(self, dir1, dir2, filename, width, height):
        path = os.path.join("assets", dir1, dir2, filename)
