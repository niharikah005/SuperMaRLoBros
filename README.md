...
Super MaRLo Bros: Making the use of Reinforcement Learning algorithms to train an agent to clear a level in a super-mario type environment.
...
- [Theory and Approach](#Theory-and-Approach)
    - [How the Code functions](#How-the-Code-functions)
    - [Resources](#Resources)
...
### Explanation:
- **First term** This is the basic policy gradient term, where the advantage is scaled by the likelihood ratio `r_t(θ)`.
